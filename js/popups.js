...
var BibliotecaSetorialCCHLA_pop = '<div class="poppy"> <ul class="tabs"> <h2>Biblioteca Setorial do CCHLA</h2> <li id="option1"> <a href="#option1" id="button1" class="onFocus" onclick="menuInterno();">Térreo</a> <div class="selected"> <img id="icone-acessibilidade" src="images/wc-inacessivel.png" title="Banheiro inacessível"><img id="icone-acessibilidade" src="images/acessivel.png" title="Acessível"> <h4>Salas</h4> <p>Sala de Atendimento ao usuário</p> </div> </li> </ul> </div>';
...
// --- INÍCIO DO CCTA ---
var SaladeConcertosRadegundisFeitosa_pop = InserirPopUp(
//Número de Andares (1,2,3)
1,
//Nome do prédio
...
var DEMUSDepartamentodeMusica_pop = InserirPopUp(
//Número de Andares (1,2,3)
1,
//Nome do prédio
...
var CCTABlocoD_pop = InserirPopUp(
//Número de Andares (1,2,3)
2,
//Nome do prédio
"CCTA - Bloco D",
...
var DACDepartamentodeArtesCenicas_pop = InserirPopUp(
//Número de Andares (1,2,3)
2,
//Nome do prédio
...
var CCTABlocoB_pop = InserirPopUp(
//Número de Andares (1,2,3)
3,
//Nome do prédio
"CCTA - Bloco B",
...
var CineAruanda_pop = InserirPopUp(
//Número de Andares (1,2,3)
1,
//Nome do prédio
"Cine Aruanda",
...
var CCTABlocoA_pop = InserirPopUp(
//Número de Andares (1,2,3)
1,
//Nome do prédio
"CCTA - Bloco A",
...
var CCTACentrosAcademicos_pop = InserirPopUp(
//Número de Andares (1,2,3)
1,
//Nome do prédio
